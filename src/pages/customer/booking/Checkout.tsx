...
const Checkout: React.FC = () => {
   const {customerId, bikeId, shopId } = useParams<{ customerId: string; bikeId: string; shopId: string }>();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post('http://localhost:5000/api/v1/bookings/book', payload, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
      });
      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="bg-red-50 text-red-600 p-6 rounded-2xl text-center">
            ...
            <p>{error}</p>
            <button onClick={() => navigate(-1)} className="mt-4 px-4 py-2 bg-red-600 text-white rounded-lg">
              Go Back
            </button>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-800">Pay at pickup</p>
                      <p className="text-xs text-gray-500">
                        You will pay the total amount directly to the shop when you collect the bike.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  {submitting ? <Loader className="h-5 w-5 animate-spin mx-auto" /> : 'Confirm Booking'}
                </button>
          ...
          <div>
            <div className="bg-white rounded-2xl shadow-md p-6 sticky top-24">
              ...
              <div className="flex gap-4 pb-4 border-b border-gray-100">
                <img
                  src={bike.images[0] || 'https://via.placeholder.com/80x80?text=Bike'}
                  alt={bike.name}
